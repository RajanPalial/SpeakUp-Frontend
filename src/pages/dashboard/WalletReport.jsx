...
const WalletReport = () => {
    const URL = "http://192.168.11.62:4000/api/users/get-transactions";
    // const apiUrl = "http://localhost:4000/api/users/api/users/get-transactions";
                        ...
                        <div className="col-md-12">
                            <div className="activation-card cus_card-1">
                                <div className="activation-card-header d-flex justify-content-between align-items-center pt-4 px-3 pb-3 rounded-3">
                                    <h2 className="m-0">Wallet Report</h2>
                                                ...
                                                {tData.map((val, i) => {
                                                    ...
                                                    return (
                                                        <tr className="activation-card-data" key={i}>
                                                            ...
                                                            <td> {val.txn_hash} </td>
                                                            <td> {status === 2 ? "Success" : status === 1 ? "In Progress" : status === 0 ? "Pending" : "Failed"} </td>
                                                            <td> {val.note} </td>
